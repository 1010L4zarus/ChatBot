...
client.on('message', message => {
  ...
  client.on("message", (message) => {
    if(message.content.startsWith("hola (*)")) {
   var ball = ['Si','No hay duda de eso','Intenta de nuevo','todo apunta a que sí','Yo digo que no','ninguna posibilidad','No lo creo','Tu mama dice que eres gay',"tal vez", "no lo se tu dime","tu crees?","puede que si o que no"];
